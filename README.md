...
> *Also available as a Claude Code Plugin:* *[github.com/Wolfgangrush/indian-labour-drafting-litigation](https://github.com/Wolfgangrush/indian-labour-drafting-litigation)*

## Case types (10)

- `id-act-section-10-reference` — ID Act Section 10 reference
- `id-act-section-2a-application` — ID Act Section 2A direct application by workman
- `labour-court-claim-statement` — Labour Court claim statement
- `gratuity-claim-controlling-authority` — Gratuity Act Section 7
- `esic-section-75-application` — ESI Court Section 75
- `epf-determination-challenge` — EPF Section 7A challenge
- `posh-internal-complaint` — POSH 2013 Internal Committee complaint
- `industrial-employment-standing-orders-certification` — Standing Orders certification
- `minimum-wages-claim` — Section 20 Minimum Wages Act
- `shops-establishments-show-cause-reply` — Reply to State S&E notice

## Install

Claude Desktop App → **Settings → Extensions → Install Extension** → `wolfgang-indian-labour-drafting.mcpb` → Enable
