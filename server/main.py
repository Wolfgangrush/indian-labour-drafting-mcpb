"""Wolfgang Rush — Indian Labour Court Drafting MCPB.

Local-execution. Covers ID Act, Gratuity, ESI/PF, POSH, Standing Orders,
Minimum Wages, Shops & Establishments.

License: MIT
Source: https://github.com/Wolfgangrush/indian-labour-drafting-mcpb
...
mcp = FastMCP("wolfgang-indian-labour-drafting")

BUNDLE_ROOT = Path(__file__).resolve().parent.parent
SKILLS_DIR = BUNDLE_ROOT / "skills"
AGENTS_DIR = BUNDLE_ROOT / "agents"
PLEADING_BASE_DIR = SKILLS_DIR / "_labour_drafting_base"
STATE_CONFIG_DIR = BUNDLE_ROOT / "state-config" / "exemplars"

CASE_TYPES: list[str] = [
    "id-act-section-10-reference",
    "id-act-section-2a-application",
    "labour-court-claim-statement",
    "gratuity-claim-controlling-authority",
    "esic-section-75-application",
    "epf-determination-challenge",
    "posh-internal-complaint",
    "industrial-employment-standing-orders-certification",
    "minimum-wages-claim",
    "shops-establishments-show-cause-reply",
]

CASE_TYPE_DESCRIPTIONS: dict[str, str] = {
    "id-act-section-10-reference": "ID Act Section 10 reference application to Labour Court / Industrial Tribunal",
    "id-act-section-2a-application": "ID Act Section 2A direct application by workman to Labour Court",
    "labour-court-claim-statement": "Labour Court claim statement (workman / employer)",
    "gratuity-claim-controlling-authority": "Gratuity claim under Section 7 Payment of Gratuity Act 1972",
    "esic-section-75-application": "ESI Court application under Section 75 ESI Act 1948",
    "epf-determination-challenge": "Challenge to EPF determination under Section 7A EPF Act 1952",
    "posh-internal-complaint": "POSH Internal Committee complaint under Sexual Harassment of Women at Workplace Act 2013",
    "industrial-employment-standing-orders-certification": "Industrial Employment Standing Orders certification application",
    "minimum-wages-claim": "Minimum Wages claim under Section 20 Minimum Wages Act 1948",
    "shops-establishments-show-cause-reply": "Reply to State Shops & Establishments Act show-cause notice",
}
...
FULL_ORCHESTRATION_SCRIPT = """# WOLFGANG RUSH — INDIAN LABOUR FORUMS (LABOUR COURT / INDUSTRIAL TRIBUNAL / CGIT) DRAFTING · FULL ORCHESTRATION SCRIPT
...
id-act-section-10-reference, id-act-section-2a-application, labour-court-claim-statement, gratuity-claim-controlling-authority, esic-section-75-application, epf-determination-challenge, posh-internal-complaint, industrial-employment-standing-orders-certification, minimum-wages-claim, shops-establishments-show-cause-reply.
...
def get_pleading_base() -> str:
    """Get the shared Labour drafting base structure."""
...
def list_states() -> dict:
    """List the State exemplars available for Labour drafting."""
...
def save_draft_as_docx(markdown_text: str, output_path: str) -> dict:
    """Save markdown draft as filing-grade .docx.
